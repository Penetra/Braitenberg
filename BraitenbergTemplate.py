...
class myBraitenbergControl( breve.BraitenbergControl ):
	...
	def init( self ):
		...
		# Light
		for i in range(20):
			breve.createInstances( breve.BraitenbergLight, 1 ).move( breve.vector( 36 + ( 14 * breve.breveInternalFunctionFinder.sin( self, ( ( i * 6.280000 ) / 20 ) ) ), 0, -65-(  14 * breve.breveInternalFunctionFinder.cos( self, ( ( i * 6.280000 ) / 20 ) ) ) ) )
		for i in range(20):
			self.smell = breve.createInstances( breve.BraitenbergSmell, 1 )
			self.smell.move( breve.vector( 60 + ( 14 * breve.breveInternalFunctionFinder.sin( self, ( ( i * 6.280000 ) / 20 ) ) ), 0, -75-(  14 * breve.breveInternalFunctionFinder.cos( self, ( ( i * 6.280000 ) / 20 ) ) ) ) )
		'''for i in range(26):
			self.smell = breve.createInstances( breve.BraitenbergSmell, 1)
