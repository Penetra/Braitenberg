...
class myBraitenbergControl( breve.BraitenbergControl ):
	...
	def init( self ):
		...
		#Smell
		for i in range(15):
			breve.createInstances( breve.BraitenbergSmell, 1 ).move( breve.vector( 36 + ( 14 * breve.breveInternalFunctionFinder.sin( self, ( ( i * 6.280000 ) / 30 ) ) ), 0, -55-(  14 * breve.breveInternalFunctionFinder.cos( self, ( ( i * 6.280000 ) / 30 ) ) ) ) )
